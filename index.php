...
function swede_data_load_scripts() {                           
    ...
    wp_localize_script('gform-repeater-js', 'ajaxurl', array(admin_url( 'admin-ajax.php' )) );  
...
//save acf json
add_filter('acf/settings/save_json', 'swede_data_json_save_point');
  
 function swede_data_json_save_point( $path ) {
     // update path
 ...
 // load acf json
 add_filter('acf/settings/load_json', 'swede_data_json_load_point');

 function swede_data_json_load_point( $paths ) {
